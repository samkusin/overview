...
MessageStream::MessageStream(size_t bufferSize, const Allocator& allocator) :
    _buffer(bufferSize, allocator)
{
}
...
MessageStream& MessageStream::operator=(MessageStream&& other)
{
