/**
 * @file    rendermodel/spriteinstance.hpp
 *
...
#ifndef CINEK_RENDER_SPRITEINSTANCE_HPP
#define CINEK_RENDER_SPRITEINSTANCE_HPP

#include <cinek/rendermodel/modelinstance.hpp>
