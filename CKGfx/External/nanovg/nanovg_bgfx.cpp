...
#include "fs_nanovg_fill.bin.h"
	...
	static int nvgRenderCreate(void* _userPtr)
	{
        ...
        */
			vs_nanovg_fill = bgfx::makeRef(vs_nanovg_fill_bin_h, sizeof(vs_nanovg_fill_bin_h) );
			fs_nanovg_fill = bgfx::makeRef(fs_nanovg_fill_bin_h, sizeof(fs_nanovg_fill_bin_h) );
			break;
		}
